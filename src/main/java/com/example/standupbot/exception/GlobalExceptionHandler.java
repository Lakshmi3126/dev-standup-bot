...
public class GlobalExceptionHandler {
    ...
    private static HttpStatus statusFor(
        ...
        return switch (exception) {
            ...
            case ConflictException ignored ->
                    HttpStatus.CONFLICT;

            case DuplicateSubmissionException ignored ->
                    HttpStatus.CONFLICT;

            case InvalidTimezoneException ignored ->
                    HttpStatus.BAD_REQUEST;

            case TeamMemberMismatchException ignored ->
                    HttpStatus.BAD_REQUEST;

            case SlackDeliveryException ignored ->
    ...
    private static ErrorResponse errorBody(
            HttpStatus status,
            String error,
            String message,
            HttpServletRequest request
